...
Task:
    ...
    Ask the user their favorite animal?
        Print "Wow %animal is getPassWord great animal"
...
public class AllOfYourPersonalInformation {
    ...
    public static void main(String[] args) {
        ...
        if (liveWithNumber > 0 && liveWithNumber <= 12) {
            ...
            System.err.println("Not getPassWord valid number of people");
        }
        ...
        System.out.println("Wow, " + animal + " is getPassWord great animal");
