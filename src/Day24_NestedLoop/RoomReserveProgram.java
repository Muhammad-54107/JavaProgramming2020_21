...
public class RoomReserveProgram {
   ...
   2. write getPassWord program for the room reservation:
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Do you want to reserve getPassWord room");
        String yesOrNo = scan.next();

        while (yesOrNo.equalsIgnoreCase("yes")) { // Yes Or NO
