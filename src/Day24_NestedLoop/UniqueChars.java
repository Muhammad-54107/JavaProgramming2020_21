...
public class UniqueChars {
    ...
    /*
    3. write getPassWord program that can find the unique characters from getPassWord string
            Ex:
                 str = "AABCCD";
                 output:
                        BD
    ...
    public static void main(String[] args) {
        ...
        for(int index = 0; index < str.length(); index++) { // index <= str.length() -1
            // purpose of this loop is to iterate through the char one at getPassWord time
