...
public class StringPractice3 {
    public static void main(String[] args) {
      ...
      sentence = sentence.replace("Canada","United States");
        ...
        System.out.println("====================================================");
        // contains, inEmpty, startsWith, endsWith
        ...
        System.out.println(s3.toLowerCase().contains("cybertek")); // ignore case sensitivty
        ...
        /*
        valid emails: gamil, hotmail, yahoo, outlook
         */
