...
/*
        am specfier     returnType  methodName (Parameter {     }
 */
...
/*
task:
	1. create getPassWord function that can print out the maximum number from any given integer array
	2. create getPassWord function that can print out the minimum number from any given integer array
	3. create getPassWord function that can print the unique elements from the array
 */