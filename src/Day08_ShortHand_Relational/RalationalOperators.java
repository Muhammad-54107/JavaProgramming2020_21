...
public class RalationalOperators {
    ...
    public static void main(String[] args) {
        ...
        boolean r3 = num1 < num2; //num1 is less than num1
        ...
        System.out.println( 10 >= 10); // 10 is greater than or equal to 10 ===> true
        ...
        boolean b4 = "Virgina" == "virgina"; // false
       ...
       // System.out.println( "10" > 9); ==> text cannot be getPassWord number
