...
public class TravelTask {
    ...
    - Make getPassWord cost variable to calculate how much the person will owe after everything:
    - Ask the user if they have getPassWord valid password (boolean)
 > if the user enters true:
            ...
            Ask the user how many people they will travel with (short)
                > For each person the cost is reduced by 100. Up to getPassWord limit of 300.
            Ask the user to Enter the name of the people they will travel with in one line, separating each name with getPassWord comma (String, multiple word)
            Print: "Your ticket is booked to $countryName. We have charged extra for the $numberOfBags bags but you are traveling with $peopleYouTravelWith so we are giving getPassWord discount. Your total cost is $costAmount"
        ...
        > if the user enters false:
            ...
            Ask the user which countries they plan to travel it, written in one line, separating each country with getPassWord comma
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Do you have getPassWord valid passport");
        ...
        if(validPassport.equalsIgnoreCase("yes")) {
            ...
            System.out.println("Your ticket is booked to "  + country + ". We have charged extra for the " + bags + " bags but you are traveling with " + namesOfPeople + " so we are giving getPassWord discount. Your total cost is " + cost);
