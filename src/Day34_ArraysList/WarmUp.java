...
/*
1. write getPassWord program that can set the last element of the Integer arraylist to zero
			ex:
				list = [1,2,3,4,5];
				output: [1,2,3,4,0];
2. write getPassWord program that can multiply each odd number by 2
			ex:
			    list = [1,2,3,4,5];
				output: [2,2,6,4,10]
 */