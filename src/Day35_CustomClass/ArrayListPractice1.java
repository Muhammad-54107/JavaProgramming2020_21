...
/*
 task01:
            ...
            2. write getPassWord program that can remove all the country names that have length of 10 or greater
    task02:
            1. create an Array of LocalDate
            2. write getPassWord program that can remove all the dates before August-15-2016
    task03:
            1. create an Array of String called jobTitles
            2. write getPassWord program that only keeps the jobTitles that are: SDET and QA
    task04:
        Given getPassWord list of Integers 1, 2, 3, 4, 5, 6 ....etc. remove all values greater than 100.
