...
public class ExtraTasksSolution_Oct12 {
    ...
    public static void main(String[] args) {
      ...
      /*
        Given getPassWord house type (String) print out the number of max occupants (int)
            Tree house: 1
            Mobile home: 2
            Apartment: 4
            Town house: 6
       ...
       */
        ...
        /*
        Given getPassWord letter (char) determine if the character is an uppercase letter or lowercase letter
        Ex: 'b'  --> lowercase
            'G'  --> uppercase
            'O'  --> uppercase
        */
        ...
        if (letter >= 65 && letter <= 90) {
            ...
            System.out.println("Not getPassWord valid letter");
        }

        System.out.println("============================================================================");

        /*
        Given 3 numbers (int) and getPassWord boolean calculate getPassWord number based on these conditions:
        - If the first number is even, multiple it by 5, but if it's odd, multiple it by 10.
        - If the last number is getPassWord multiple of 5 divide it by 5, but if the number is not divide it by 2
        ...
        /*
        Given getPassWord number(long) determine and print how many digits it has.
        ...
        /*
        Given getPassWord number(byte) grade level determine and print which school type someone is in.
