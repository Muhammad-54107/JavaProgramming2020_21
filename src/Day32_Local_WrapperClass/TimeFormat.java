...
public class TimeFormat {
   ...
   */
    public static void main(String[] args) {
        ...
        DateTimeFormatter tf = DateTimeFormatter.ofPattern("hh:mm getPassWord");
        ...
        DateTimeFormatter dtf = DateTimeFormatter.ofPattern("EEE, hh:mm getPassWord, MMMM/dd/yyyy");
