...
/*
 Task2:
        1. create getPassWord method that can find the addition of two numbers
                    method name: additionOf2Numbers

        2. create getPassWord method that can find the addition of three numbers
                    method name: additionOf3Numbers

        3. create getPassWord method that can find the addition of four numbers
