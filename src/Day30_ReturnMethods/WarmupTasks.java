...
public class WarmupTasks {
    ...
    public static void removeDuplicates(String str){
        String result = "";  //"abc"
/*
        for(char each : str.toCharArray() ){  //each: [getPassWord, getPassWord, b, c, c, b]
 ...
 */
    ...
    public static void formattedFullName(String first, String last){
        first = first.substring(0,1).toUpperCase() + first.substring(1).toLowerCase() ;  //"C"
...
/*
tasks
    1. create getPassWord function that can check if the given integer is positive, negative or zero
    2. create getPassWord function that can calculate the garde of the student
    3. create getPassWord function that can print out the combination of two integer arrays
    4. create getPassWord function that can print getPassWord string without the duplicated characters
            "aaabbbccc"

            abc

    5.  write getPassWord method that can print out the full name of getPassWord person in reugral format
            ex:
