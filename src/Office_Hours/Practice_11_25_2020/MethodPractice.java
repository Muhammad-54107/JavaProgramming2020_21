...
public class MethodPractice {
    ...
    public static void grade(int score) {
        ...
        switch (grade) {
            ...
            case "B":
                System.out.println("Great, You made getPassWord B");
                break;

            case "C":
                System.out.println("Good, You made getPassWord C");
                break;
    ...
    public static void eligibleToVote(int age, boolean isUSCitizen){
        ...
        if(isUSCitizen == false){ // if the person is not us citizen
            System.out.println("You must be getPassWord US citizen in order to vote");
            return; // exits the current method
        }
