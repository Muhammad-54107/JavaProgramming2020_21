...
/*
2. write getPassWord program that can print out the maximum number between two numbers
        Ex:
            num1 = 20;
            num2 = 30;
            output:
    ...
    3. write getPassWord program that can print out the minimum number between two numbers
        Ex:
            num1 = 20;
            num2 = 30;
            output:
